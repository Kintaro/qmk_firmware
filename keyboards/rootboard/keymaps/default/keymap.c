...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_B,         KC_V,         KC_K,         OSL(3),         KC_Q,                    KC_Z,          OSL(1),         KC_QUOT,      KC_SLASH,     KC_DOT,
                                    LT(9, KC_R),  KC_BSPC,      LT(11, KC_TAB),           LT(10, KC_DOT), LT(10, KC_ENT),       LSFT_T(KC_SPC)
			     ),
    // C
    ...
    [10] = LAYOUT_split_3x5_3(
        _______,      KC_1,      KC_2,      KC_3,      _______,                 _______,       LSFT(KC_1),      LSFT(KC_2),      LSFT(KC_3),      _______,
	    _______,      KC_4,      KC_5,      KC_6,      _______,                 _______,       LSFT(KC_4),      LSFT(KC_5),      LSFT(KC_6),      _______,
        _______,      KC_7,      KC_8,      KC_9,      _______,                 _______,       LSFT(KC_7),      LSFT(KC_8),      LSFT(KC_9),      _______,
